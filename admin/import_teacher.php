...
<body>
	...
	<div class="col-md-6 well">
		...
		<div class="col-md-4" style='overflow:hidden;'>
			<form action="upload2.php" class="form-inline" method="POST" enctype="multipart/form-data">
				<div class="form-group">
					<label>CSV here:</label>
					<br />
		...
		<div class="col-md-8">
			<table class="table table-bordered">
				...
				<tbody>
					<?php
						require'conn.php';
						$query=mysqli_query($conn, "SELECT * FROM `faculty_list`") or die(mysqli_error());
