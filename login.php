    ...
    <div class="card-body login-card-body">
      <form action="" id="login-form">
        <div class="input-group mb-3">
          <input type="school_id" class="form-control" name="school_id" placeholder="School ID Ex:SCC-XX-XXXXXXX">
...
// echo '<br></center>';
echo '<li><a style="color:#FFFFFF" href="index.php?info=login3.php"><i class="fa fa-sign-out fa-fw"></i>Registration</a></li>';
 ?>
<form>
<input class="MyButton" type="button" value="Log in as Teacher" onclick="window.location.href='teacher.php'"/>
</form>
